...
*--//Table 2 - Unit Root tests//--* however kpss test is perform using R studio
*Table 3 ADF
dfuller lnco2
dfuller lnco2
dfuller d.lnco2
...
*--//Table 4 - ARDL diagnostics tests //--*
**A: Bounds testing
estat ectest
...
**# Table 8 and Fig 7: Results of DYNARDL  #
